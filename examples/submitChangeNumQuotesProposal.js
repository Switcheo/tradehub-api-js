...
const { RestClient, Network, newAccount, WalletClient, CHANGE_NUM_QUOTES_PROPOSAL_TYPE } = require('tradehub-api-js')
...
async function submit() {
  ...
  const proposalMsg = {
    content: {
      type: CHANGE_NUM_QUOTES_PROPOSAL_TYPE,
      value: {
        title: 'my title',
...
console.log(CHANGE_NUM_QUOTES_PROPOSAL_TYPE)
submit()
